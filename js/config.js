/* =============================================
   ...
   - All data last verified: 2026-08-05
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 331.57,         // previous close
            today: 334,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 334,          // auto-updated 2026-08-05
            prevPrice: 331.57,      // previous: 347.78
            unit: 'USD/MT',
