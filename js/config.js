/* =============================================
   ...
   - All data last verified: 2026-08-07
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 334,         // previous close
            today: 343.26,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 343.26,          // auto-updated 2026-08-06
            prevPrice: 334,      // previous: 349.98
            unit: 'USD/MT',
