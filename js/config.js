/* =============================================
   ...
   - All data last verified: 2026-07-12
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 333.34,         // previous close
            today: 327.61,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 327.61,          // auto-updated 2026-07-10
            prevPrice: 333.34,      // previous: 351.31
            unit: 'USD/MT',
