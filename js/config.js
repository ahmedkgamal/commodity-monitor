/* =============================================
   ...
   - All data last verified: 2026-05-07
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 326.5,         // previous close
            today: 334.66,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 334.66,          // auto-updated 2026-05-07
            prevPrice: 326.5,      // previous: 350.42
            unit: 'USD/MT',
