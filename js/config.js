/* =============================================
   ...
   - All data last verified: 2026-09-12
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 412.93,         // previous close
            today: 400.14,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 400.14,          // auto-updated 2026-09-11
            prevPrice: 412.93,      // previous: 382.5
            unit: 'USD/MT',
