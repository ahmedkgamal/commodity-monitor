/* =============================================
   ...
   - All data last verified: 2026-07-14
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 325.18,         // previous close
            today: 325.84,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 325.84,          // auto-updated 2026-07-14
            prevPrice: 325.18,      // previous: 345.13
            unit: 'USD/MT',
