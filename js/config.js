/* =============================================
   ...
   - All data last verified: 2026-06-15
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 302.03,         // previous close
            today: 316.58,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 316.58,          // auto-updated 2026-06-15
            prevPrice: 302.03,      // previous: 333.89
            unit: 'USD/MT',
