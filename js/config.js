/* =============================================
   ...
   - All data last verified: 2026-05-14
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 339.07,         // previous close
            today: 335.98,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 335.98,          // auto-updated 2026-05-14
            prevPrice: 339.07,      // previous: 370.05
            unit: 'USD/MT',
