/* =============================================
   ...
   - All data last verified: 2026-05-13
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 330.91,         // previous close
            today: 331.57,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 331.57,          // auto-updated 2026-05-13
            prevPrice: 330.91,      // previous: 364.75
            unit: 'USD/MT',
