/* =============================================
   ...
   - All data last verified: 2026-09-01
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 392.64,         // previous close
            today: 391.1,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 391.1,          // auto-updated 2026-09-01
            prevPrice: 392.64,      // previous: 380.52
            unit: 'USD/MT',
