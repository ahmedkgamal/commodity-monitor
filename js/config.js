/* =============================================
   ...
   - All data last verified: 2026-04-06
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 337.09,         // previous close
            today: 330.69,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 330.69,          // auto-updated 2026-04-02
            prevPrice: 337.09,      // previous: 349.87
            unit: 'USD/MT',
