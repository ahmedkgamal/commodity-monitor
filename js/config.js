/* =============================================
   ...
   - All data last verified: 2026-08-16
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 370.82,         // previous close
            today: 365.97,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 365.97,          // auto-updated 2026-08-14
            prevPrice: 370.82,      // previous: 348.66
            unit: 'USD/MT',
