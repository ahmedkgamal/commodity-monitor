/* =============================================
   ...
   - All data last verified: 2026-04-30
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 323.64,         // previous close
            today: 326.5,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 326.5,          // auto-updated 2026-04-30
            prevPrice: 323.64,      // previous: 354.61
            unit: 'USD/MT',
