/* =============================================
   ...
   - All data last verified: 2026-08-09
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 343.26,         // previous close
            today: 363.54,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 363.54,          // auto-updated 2026-08-07
            prevPrice: 343.26,      // previous: 345.46
            unit: 'USD/MT',
