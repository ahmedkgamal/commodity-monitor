/* =============================================
   ...
   - All data last verified: 2026-09-24
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 391.32,         // previous close
            today: 413.59,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 413.59,          // auto-updated 2026-09-24
            prevPrice: 391.32,      // previous: 412.59
            unit: 'USD/MT',
