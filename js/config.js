/* =============================================
   ...
   - All data last verified: 2026-08-26
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 389.12,         // previous close
            today: 380.74,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 380.74,          // auto-updated 2026-08-25
            prevPrice: 389.12,      // previous: 366.63
            unit: 'USD/MT',
