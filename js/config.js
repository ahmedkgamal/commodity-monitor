/* =============================================
   ...
   - All data last verified: 2026-09-16
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 395.51,         // previous close
            today: 415.57,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 415.57,          // auto-updated 2026-09-16
            prevPrice: 395.51,      // previous: 403.89
            unit: 'USD/MT',
