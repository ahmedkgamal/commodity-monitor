/* =============================================
   ...
   - All data last verified: 2026-06-27
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 298.73,         // previous close
            today: 308.21,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 308.21,          // auto-updated 2026-06-26
            prevPrice: 298.73,      // previous: 338.41
            unit: 'USD/MT',
