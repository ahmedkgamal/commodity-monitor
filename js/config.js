/* =============================================
   ...
   - All data last verified: 2026-05-03
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 321.43,         // previous close
            today: 330.03,                  // Bursa FCPO May-26 settlement (Mar 12)
            ...
            originalPrice: { value: 4549, unit: 'MYR/ton' },
        ...
        raw_sugar: {
            ...
            originalPrice: { value: 14.35, unit: 'cents/lb' },
            // Jan: FRED verified; Feb: Yahoo Finance 19-day avg; Mar onward: null
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 330.03,          // auto-updated 2026-05-01
            prevPrice: 321.43,      // previous: 351.97
            unit: 'USD/MT',
