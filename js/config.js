/* =============================================
   ...
   - All data last verified: 2026-04-15
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 306,         // previous close
            today: 312.62,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 312.62,          // auto-updated 2026-04-15
            prevPrice: 306,      // previous: 364.53
            unit: 'USD/MT',
