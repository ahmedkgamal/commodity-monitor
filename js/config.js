/* =============================================
   ...
   - All data last verified: 2026-09-17
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 396.17,         // previous close
            today: 412.48,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 412.48,          // auto-updated 2026-09-17
            prevPrice: 396.17,      // previous: 409.95
            unit: 'USD/MT',
