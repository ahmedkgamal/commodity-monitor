/* =============================================
   ...
   - All data last verified: 2026-06-25
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 295.86,         // previous close
            today: 292.99,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 292.99,          // auto-updated 2026-06-25
            prevPrice: 295.86,      // previous: 336.09
            unit: 'USD/MT',
