/* =============================================
   ...
   - All data last verified: 2026-09-10
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 405.65,         // previous close
            today: 432.77,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 432.77,          // auto-updated 2026-09-10
            prevPrice: 405.65,      // previous: 390.55
            unit: 'USD/MT',
