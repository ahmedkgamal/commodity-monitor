/* =============================================
   ...
   - All data last verified: 2026-08-18
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 365.97,         // previous close
            today: 371.92,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 371.92,          // auto-updated 2026-08-17
            prevPrice: 365.97,      // previous: 354.28
            unit: 'USD/MT',
