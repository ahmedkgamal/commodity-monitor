/* =============================================
   ...
   - All data last verified: 2026-09-25
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 387.57,         // previous close
            today: 411.82,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 411.82,          // auto-updated 2026-09-25
            prevPrice: 387.57,      // previous: 405.76
            unit: 'USD/MT',
