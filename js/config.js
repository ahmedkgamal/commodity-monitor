/* =============================================
   ...
   - All data last verified: 2026-06-17
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 304.68,         // previous close
            today: 313.28,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 313.28,          // auto-updated 2026-06-17
            prevPrice: 304.68,      // previous: 339.62
            unit: 'USD/MT',
