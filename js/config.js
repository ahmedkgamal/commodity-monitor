/* =============================================
   ...
   - All data last verified: 2026-05-06
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 338.85,         // previous close
            today: 331.35,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 331.35,          // auto-updated 2026-05-06
            prevPrice: 338.85,      // previous: 355.94
            unit: 'USD/MT',
