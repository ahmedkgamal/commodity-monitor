/* =============================================
   ...
   - All data last verified: 2026-07-30
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 319.67,         // previous close
            today: 318.79,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 318.79,          // auto-updated 2026-07-30
            prevPrice: 319.67,      // previous: 356.49
            unit: 'USD/MT',
