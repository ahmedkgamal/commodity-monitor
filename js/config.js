/* =============================================
   ...
   - All data last verified: 2026-05-12
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 328.71,         // previous close
            today: 332.9,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 332.9,          // auto-updated 2026-05-12
            prevPrice: 328.71,      // previous: 357.37
            unit: 'USD/MT',
