/* =============================================
   ...
   - All data last verified: 2026-09-14
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 400.14,         // previous close
            today: 420.42,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 420.42,          // auto-updated 2026-09-14
            prevPrice: 400.14,      // previous: 389.34
            unit: 'USD/MT',
