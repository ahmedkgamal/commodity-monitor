/* =============================================
   ...
   - All data last verified: 2026-07-03
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 330.47,         // previous close
            today: 327.39,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 327.39,          // auto-updated 2026-07-02
            prevPrice: 330.47,      // previous: 339.18
            unit: 'USD/MT',
