/* =============================================
   ...
   - All data last verified: 2026-07-16
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 327.39,         // previous close
            today: 324.52,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 324.52,          // auto-updated 2026-07-16
            prevPrice: 327.39,      // previous: 354.72
            unit: 'USD/MT',
