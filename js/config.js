/* =============================================
   ...
   - All data last verified: 2026-08-21
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 386.91,         // previous close
            today: 386.25,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 386.25,          // auto-updated 2026-08-20
            prevPrice: 386.91,      // previous: 354.28
            unit: 'USD/MT',
