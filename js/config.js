/* =============================================
   ...
   - All data last verified: 2026-07-25
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 363.65,         // previous close
            today: 365.2,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 365.2,          // auto-updated 2026-07-24
            prevPrice: 363.65,      // previous: 458.52
            unit: 'USD/MT',
