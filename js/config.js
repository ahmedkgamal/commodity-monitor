/* =============================================
   ...
   - All data last verified: 2026-08-27
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 387.79,         // previous close
            today: 401.68,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 401.68,          // auto-updated 2026-08-27
            prevPrice: 387.79,      // previous: 376.66
            unit: 'USD/MT',
