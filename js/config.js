/* =============================================
   ...
   - All data last verified: 2026-04-21
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 296.96,         // previous close
            today: 299.17,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 299.17,          // auto-updated 2026-04-21
            prevPrice: 296.96,      // previous: 354.83
            unit: 'USD/MT',
