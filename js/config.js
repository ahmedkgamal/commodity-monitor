/* =============================================
   ...
   - All data last verified: 2026-09-09
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 399.04,         // previous close
            today: 427.03,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 427.03,          // auto-updated 2026-09-09
            prevPrice: 399.04,      // previous: 387.9
            unit: 'USD/MT',
