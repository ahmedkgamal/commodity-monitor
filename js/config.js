/* =============================================
   ...
   - All data last verified: 2026-07-13
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 328.05,         // previous close
            today: 323.42,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 323.42,          // auto-updated 2026-07-13
            prevPrice: 328.05,      // previous: 352.63
            unit: 'USD/MT',
