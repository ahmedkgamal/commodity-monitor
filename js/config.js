/* =============================================
   ...
   - All data last verified: 2026-07-21
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 326.72,         // previous close
            today: 328.27,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 328.27,          // auto-updated 2026-07-21
            prevPrice: 326.72,      // previous: 357.37
            unit: 'USD/MT',
