/* =============================================
   ...
   - All data last verified: 2026-08-30
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 401.02,         // previous close
            today: 387.13,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 387.13,          // auto-updated 2026-08-28
            prevPrice: 401.02,      // previous: 384.6
            unit: 'USD/MT',
