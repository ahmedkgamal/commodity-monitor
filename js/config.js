/* =============================================
   ...
   - All data last verified: 2026-04-12
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 306.88,         // previous close
            today: 303.36,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 303.36,          // auto-updated 2026-04-10
            prevPrice: 306.88,      // previous: 365.75
            unit: 'USD/MT',
