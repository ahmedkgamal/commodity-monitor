/* =============================================
   ...
   - All data last verified: 2026-07-09
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 333.12,         // previous close
            today: 331.13,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 331.13,          // auto-updated 2026-07-09
            prevPrice: 333.12,      // previous: 341.28
            unit: 'USD/MT',
