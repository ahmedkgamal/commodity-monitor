/* =============================================
   ...
   - All data last verified: 2026-04-29
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 311.07,         // previous close
            today: 315.7,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 315.7,          // auto-updated 2026-04-29
            prevPrice: 311.07,      // previous: 363.65
            unit: 'USD/MT',
