/* =============================================
   ...
   - All data last verified: 2026-08-25
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 388.23,         // previous close
            today: 389.12,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 389.12,          // auto-updated 2026-08-24
            prevPrice: 388.23,      // previous: 362.88
            unit: 'USD/MT',
