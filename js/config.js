/* =============================================
   ...
   - All data last verified: 2026-08-12
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 363.1,         // previous close
            today: 368.83,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 368.83,          // auto-updated 2026-08-11
            prevPrice: 363.1,      // previous: 344.8
            unit: 'USD/MT',
