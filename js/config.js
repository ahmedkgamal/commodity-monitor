/* =============================================
   ...
   - All data last verified: 2026-07-29
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 320.77,         // previous close
            today: 322.76,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 322.76,          // auto-updated 2026-07-29
            prevPrice: 320.77,      // previous: 357.15
            unit: 'USD/MT',
