/* =============================================
   ...
   - All data last verified: 2026-09-05
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 398.37,         // previous close
            today: 398.37,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 398.37,          // auto-updated 2026-09-04
            prevPrice: 398.37,      // previous: 380.63
            unit: 'USD/MT',
