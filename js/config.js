...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 299.17,         // previous close
            today: 305.34,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 305.34,          // auto-updated 2026-04-23
            prevPrice: 299.17,      // previous: 350.2
            unit: 'USD/MT',
