...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 318.13,         // previous close
            today: 322.98,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 322.98,          // auto-updated 2026-07-31
            prevPrice: 318.13,      // previous: 354.06
            unit: 'USD/MT',
