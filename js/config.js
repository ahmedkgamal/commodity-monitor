/* =============================================
   ...
   - All data last verified: 2026-07-27
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 325.62,         // previous close
            today: 321.43,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 321.43,          // auto-updated 2026-07-27
            prevPrice: 325.62,      // previous: 360.12
            unit: 'USD/MT',
