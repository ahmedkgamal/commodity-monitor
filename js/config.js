/* =============================================
   ...
   - All data last verified: 2026-07-19
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 318.35,         // previous close
            today: 326.72,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 326.72,          // auto-updated 2026-07-17
            prevPrice: 318.35,      // previous: 351.09
            unit: 'USD/MT',
