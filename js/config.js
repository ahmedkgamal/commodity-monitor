/* =============================================
   ...
   - All data last verified: 2026-08-31
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 387.13,         // previous close
            today: 391.54,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 391.54,          // auto-updated 2026-08-31
            prevPrice: 387.13,      // previous: 378.75
            unit: 'USD/MT',
