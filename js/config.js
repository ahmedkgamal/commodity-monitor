/* =============================================
   ...
   - All data last verified: 2026-09-15
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 400.36,         // previous close
            today: 403.23,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 403.23,          // auto-updated 2026-09-15
            prevPrice: 400.36,      // previous: 390
            unit: 'USD/MT',
