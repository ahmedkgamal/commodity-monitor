/* =============================================
   ...
   - All data last verified: 2026-06-14
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 304.02,         // previous close
            today: 302.03,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 302.03,          // auto-updated 2026-06-12
            prevPrice: 304.02,      // previous: 332.13
            unit: 'USD/MT',
