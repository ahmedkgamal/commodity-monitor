...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 330.03,         // previous close
            today: 325.18,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 325.18,          // auto-updated 2026-04-07
            prevPrice: 330.03,      // previous: 347.78
            unit: 'USD/MT',
