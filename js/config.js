/* =============================================
   ...
   - All data last verified: 2026-04-26
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 299.83,         // previous close
            today: 310.85,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 310.85,          // auto-updated 2026-04-24
            prevPrice: 299.83,      // previous: 351.75
            unit: 'USD/MT',
