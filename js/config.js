/* =============================================
   ...
   - All data last verified: 2026-06-09
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 311.29,         // previous close
            today: 310.41,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 310.41,          // auto-updated 2026-06-09
            prevPrice: 311.29,      // previous: 336.65
            unit: 'USD/MT',
