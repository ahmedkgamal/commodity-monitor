/* =============================================
   ...
   - All data last verified: 2026-09-03
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 412.26,         // previous close
            today: 397.49,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 397.49,          // auto-updated 2026-09-03
            prevPrice: 412.26,      // previous: 384.82
            unit: 'USD/MT',
