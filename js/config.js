/* =============================================
   ...
   - All data last verified: 2026-05-26
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 324.08,         // previous close
            today: 319.89,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 319.89,          // auto-updated 2026-05-26
            prevPrice: 324.08,      // previous: 363.87
            unit: 'USD/MT',
