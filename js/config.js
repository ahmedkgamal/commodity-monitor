/* =============================================
   ...
   - All data last verified: 2026-05-27
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 320.55,         // previous close
            today: 316.14,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 316.14,          // auto-updated 2026-05-27
            prevPrice: 320.55,      // previous: 362.44
            unit: 'USD/MT',
