/* =============================================
   ...
   - All data last verified: 2026-08-19
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 371.92,         // previous close
            today: 385.15,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 385.15,          // auto-updated 2026-08-18
            prevPrice: 371.92,      // previous: 352.3
            unit: 'USD/MT',
