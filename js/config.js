/* =============================================
   ...
   - All data last verified: 2026-08-24
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 386.25,         // previous close
            today: 388.23,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 388.23,          // auto-updated 2026-08-21
            prevPrice: 386.25,      // previous: 360.57
            unit: 'USD/MT',
