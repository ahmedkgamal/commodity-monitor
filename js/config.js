/* =============================================
   ...
   - All data last verified: 2026-08-20
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 385.15,         // previous close
            today: 386.91,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 386.91,          // auto-updated 2026-08-19
            prevPrice: 385.15,      // previous: 360.12
            unit: 'USD/MT',
