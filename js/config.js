/* =============================================
   ...
   - All data last verified: 2026-08-11
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 362.66,         // previous close
            today: 363.1,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 363.1,          // auto-updated 2026-08-10
            prevPrice: 362.66,      // previous: 343.37
            unit: 'USD/MT',
