/* =============================================
   ...
   - All data last verified: 2026-06-29
...
const CONFIG = {
    ...
    sampleData: {
        cpo: {
            ...
            yesterdayClose: 308.21,         // previous close
            today: 321.87,                  // Bursa FCPO May-26 settlement (Mar 12)
    ...
    compactCommodities: [
        // --- EDIBLE OILS ---
        {
            group: 'Edible Oils',
            name: 'Crude Palm Oil (CPO)',
            price: 321.87,          // auto-updated 2026-06-29
            prevPrice: 308.21,      // previous: 334.77
            unit: 'USD/MT',
